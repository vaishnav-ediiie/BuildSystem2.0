...
namespace CustomBuildSystem
{
    ...
    public class CellPlaceableSO : PlaceableSOBase
    {
        ...
        [SerializeField] private CellPlacementCriteria placementCriteria;
        ...
        public bool AreBaseConditionsSatisfied(BSS_PlacingCell placingCell) =>
            this.placementCriteria.AreSatisfied(placingCell.BuildSystem, LayoutInfo(placingCell.CellNumber, placingCell.Rotation));
    }

    [Serializable]
    public class CellPlacementCriteria
    {
        [SerializeField, Tooltip("Cells exactly one floor above the object")]
        private Condition cellAbove;

        [SerializeField, Tooltip("Cells exactly one floor below the object")]
        private Condition cellBelow;

        [SerializeField, Tooltip("Cells that are within the bonds of object")]
        private Condition cellCenter = Condition.CenterCellCondition;

        [SerializeField, Tooltip("Cells that share common edge")]
        private Condition cellSide;

        [SerializeField, Tooltip("Cells that share same corner")]
        private Condition cellCorner;

        [SerializeField, Tooltip("Boundary of Object")]
        private Condition edgeBoundary;

        [SerializeField, Tooltip("Edges that are enclosed")]
        private Condition edgeBetween;
